...
import org.jboss.arquillian.gradle.task.ArquillianDeploy
import org.jboss.arquillian.gradle.utils.ContainerManager
import spock.lang.Specification

/**
 * Arquillian deploy task unit test.
 *
 * @author Benjamin Muschko
 */
class ArquillianDeploySpec extends Specification {
    static final TASK_NAME = 'arquillianJettyDeploy'
    Project project
    ...
    def "Executes task for thrown exception"() {
        ...
        when:
            Task task = project.task(TASK_NAME, type: ArquillianDeploy) {
