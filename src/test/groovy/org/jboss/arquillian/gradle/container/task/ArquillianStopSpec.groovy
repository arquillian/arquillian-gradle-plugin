...
import org.jboss.arquillian.gradle.task.ArquillianStop
import org.jboss.arquillian.gradle.utils.ContainerManager
import spock.lang.Specification

/**
 * Arquillian stop task unit test.
 *
 * @author Benjamin Muschko
 */
class ArquillianStopSpec extends Specification {
    static final TASK_NAME = 'arquillianJettyStop'
    Project project
    ...
    def "Executes task for thrown exception"() {
        ...
        when:
            Task task = project.task(TASK_NAME, type: ArquillianStop) {
