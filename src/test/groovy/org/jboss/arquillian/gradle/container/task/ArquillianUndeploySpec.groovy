...
import org.jboss.arquillian.gradle.task.ArquillianUndeploy
import org.jboss.arquillian.gradle.utils.ContainerManager
import spock.lang.Specification

/**
 * Arquillian undeploy task unit test.
 *
 * @author Benjamin Muschko
 */
class ArquillianUndeploySpec extends Specification {
    static final TASK_NAME = 'arquillianJettyUndeploy'
    Project project
    ...
    def "Executes task for thrown exception"() {
        ...
        when:
            Task task = project.task(TASK_NAME, type: ArquillianUndeploy) {
        ...
        then:
            ...
            0 * mockContainerManager.undeploy(deployableFile)
    }
    ...
    def "Executes task if deployable is not provided"() {
        ...
        then:
            ...
            0 * mockContainerManager.undeploy(nonExistentDeployable)
    }
    ...
    def "Executes task successfully"() {
        ...
        then:
            ...
            1 * mockContainerManager.undeploy(deployableFile)
    }
}
